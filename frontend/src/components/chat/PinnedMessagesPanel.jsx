...
export function PinnedMessagesPanel({ onClose }) {
  ...
  return <div className="fixed sm:absolute top-16 sm:top-[calc(100%+0.5rem)] right-2 sm:right-0 z-50 w-[calc(100vw-1rem)] sm:w-[22rem] rounded-xl border border-border bg-background p-2 shadow-xl">
