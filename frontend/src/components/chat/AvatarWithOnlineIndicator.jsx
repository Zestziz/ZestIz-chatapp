 ...
 */
export function AvatarWithOnlineIndicator({ isOnline, children, dotClassName = "", onClick }) {
  return (
    <div className="relative inline-flex shrink-0" onClick={onClick} role={onClick ? "button" : undefined} tabIndex={onClick ? 0 : undefined}>
      {children}
      <span
